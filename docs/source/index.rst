...
Preconfigured dashboards provide a view into a company's risks related to PII, so that engineering and security leaders could make informed security and privacy decisions.
...
Metadata about the requests is then collected and sent to the Soveren Cloud.
The metadata contains information about how the payload was structured (what the fields were), what sorts of PIIs were detected, what services were involved in the communication.
