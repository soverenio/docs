...
Using Kubernetes gives you the benefits of a Kubernetes cluster, while using Docker Compose allows you to deploy a gateway image directly on a single node.
